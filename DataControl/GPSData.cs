...
namespace MavBoia.DataControl
{
    public class GPSData : IBoatData
    {
        ...
        private float course; /*< [deg] Direction of movement(not heading)*/
        private float heading; /*< [deg] Direction of the bow (source not from GPS, but from IMU)*/
        private float satellites_visible; /*<  */
        private int hdop; /*<  Horizontal dilution of precision. Represents quality of GPS constellation. Values close to 1 are best. Above 5 is poor*/

        public double Latitude { get => latitude; set => latitude = value; }
        public double Longitude { get => longitude; set => longitude = value; }
        public float Speed { get => speed; set => speed = value; }
        public float Course { get => course; set => course = value; }
        public float Heading { get => heading; set => heading = value; }
        public float Satellites_visible { get => satellites_visible; set => satellites_visible = value; }
